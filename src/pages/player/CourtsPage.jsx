  ...
  return (
    <div className="space-y-6 py-2 w-full mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto">
            {['all', 'Outdoor', 'Indoor'].map((fmt) => (
              <button
                ...
                className={`px-4 py-2.5 rounded-lg text-xs font-black transition-all uppercase border ${
                  formatFilter === fmt
