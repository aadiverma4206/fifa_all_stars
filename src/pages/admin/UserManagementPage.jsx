  ...
  return (
    <div className="space-y-6 py-6 max-w-[1750px] w-full mx-auto px-4 sm:px-8 lg:px-10 overflow-x-hidden">
      ...
      <div className="admin-card p-3 rounded-lg flex flex-col md:flex-row items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="flex items-center gap-1.5 p-1 bg-slate-100 dark:bg-slate-950 rounded-md border border-slate-200/60 dark:border-slate-800/60 overflow-x-auto max-w-full scrollbar-none w-full md:w-auto">
          {[
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 pt-2">
              <button
                ...
                className="w-full sm:flex-1 py-2.5 rounded-md border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="w-full sm:flex-1 py-2.5 rounded-md bg-amber-500 hover:bg-amber-600 text-slate-950 text-xs font-bold shadow-sm transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isChangingRole ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 pt-2">
              ...
              <button
                ...
                className={`w-full sm:flex-1 py-2.5 rounded-md text-white text-xs font-bold shadow-sm transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed ${
                  blockConfirmTarget.status === 'SUSPENDED'
