...
export const Badge = ({ children, variant = 'default', size = 'md', className = '' }) => {
  ...
  const variants = {
    ...
    green: 'bg-sport-500/10 text-sport-600 dark:text-sport-400 border border-sport-500/30',
    success: 'bg-sport-500/10 text-sport-600 dark:text-sport-400 border border-sport-500/30',
    ...
    sky: 'bg-sky-500/10 text-sky-600 dark:text-sky-400 border border-sky-500/30',
    ...
    red: 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/30',
  ...
  return (
    <span className={clsx(baseStyles, selectedVariant, selectedSize, className)}>
      {children}
    </span>
  );
};
